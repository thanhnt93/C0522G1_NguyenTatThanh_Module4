...
//    Page<Employee> findAll2(Pageable pageable);
    ...
    @Query(value = "select * from employee where is_delete = 0 and name like %:keySearch%", nativeQuery = true)
    Page<Employee> findAllByName(@Param("keySearch") String search,Pageable pageable);
